...
import {SearchNormal1,Profile2User, Message, Information, Shop, Note, Home3} from 'iconsax-react-native';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header2}>
          ...
          <Home3 color={colors.black()} variant="Linear" size={25} style={styles.searchIcon} />
